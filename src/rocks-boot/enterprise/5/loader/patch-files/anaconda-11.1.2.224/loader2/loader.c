...
static void parseCmdLineFlags(struct loaderData_s * loaderData,
    ...
    for (i=0; i < argc; i++) {
        if (!strcasecmp(argv[i], "expert")) {
            ...
            loaderData->ksFile = p;
            logMessage(INFO, "ROCKS:central:server is %s", loaderData->ksFile);
        }
#endif /* ROCKS */
...
int main(int argc, char ** argv) {
    ...
    /** XX ROCKS **/
     fprintf (stderr, "Loader Getting Init.pid options \n");
    /** XX ROCKS **/
    ...
    /** XX ROCKS **/
     fprintf (stderr, "Loader parsing command options \n");
    /** XX ROCKS **/
    /* now we parse command line options */
    optCon = poptGetContext(NULL, argc, (const char **) argv, optionTable, 0);

    /** XX ROCKS **/
     fprintf (stderr, "Loader finished parsing command options \n");
    /** XX ROCKS **/
    ...
    extraArgs[0] = NULL;
    /** XX ROCKS **/
     fprintf (stderr, "Loader parsing CmdLineFlags \n");
    /** XX ROCKS **/
    parseCmdLineFlags(&loaderData, cmdLine);
    /** XX ROCKS **/
     fprintf (stderr, "Loader Finished CmdLineFlags \n");
    /** XX ROCKS **/
    ...
    /** XX ROCKS **/
     fprintf (stderr, " Initializing Console\n");
    /** XX ROCKS **/
    ...
    /** XX ROCKS **/
     fprintf (stderr, " USB Initialize \n");
    /** XX ROCKS **/
    usbInitialize(modLoaded, modDeps, modInfo);
    
    /** XX ROCKS **/
     fprintf (stderr, " Firewire Initialize \n");
    /** XX ROCKS **/
    ...
    if (loaderData.ksFile || ksFile) {
        ...
        {
    /** XX ROCKS **/
     fprintf (stderr, " Starting some Rocks Specific -- no ksFile \n");
    /** XX ROCKS **/
            /*
