...
typedef	struct s_GeInit {
	...
	SK_U8		GIPciMode;		/* PCI/PCIX Mode & PCI-X Clock */
	SK_U8		GIPexWidth;		/* PEX Negotiated Link Width */
...
#ifndef SK_DIAG
	int			GICrcLen;		/* num of CRC bytes to be removed by driver */
#endif
} SK_GEINIT;
